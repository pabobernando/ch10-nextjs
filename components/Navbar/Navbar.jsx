...
function Navbar() {
  ...
  <div class="flex items-center flex-shrink-0 text-white mr-6">
    ...
    <span class="font-semibold text-xl tracking-tight">Binar Accademy</span>
  </div>
  <div class="block lg:hidden">
    <button class="flex items-center px-3 py-2 border rounded text-purple-300 border-purple-400 hover:text-white hover:border-white">
