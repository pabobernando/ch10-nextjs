...
function Navbar () {
  ...
  <div className="flex items-center flex-shrink-0 text-white mr-6">
    ...
    <span className="font-semibold text-xl tracking-tight">Binar Accademy</span>
  </div>
  ...
  <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
    <div className="text-sm lg:flex-grow text-right">
      ...
      <a href="#responsive-header" className="block mt-4 lg:inline-block lg:mt-0 text-white hover:text-violet-500">
        Dashboard
      </a>
    </div>
  </div>
